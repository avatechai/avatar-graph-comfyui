...
uv_api = ['align', 'align_rotation', 'average_islands_scale', 'copy', 'cube_project', 'cursor_set', 'cylinder_project', 'export_layout', 'follow_active_quads', 'hide', 'lightmap_pack', 'mark_seam', 'minimize_stretch', 'pack_islands', 'paste', 'pin', 'project_from_view', 'randomize_uv_transform', 'remove_doubles', 'reset', 'reveal', 'rip', 'rip_move', 'seams_from_islands', 'select',
          'select_all', 'select_box', 'select_circle', 'select_edge_ring', 'select_lasso', 'select_less', 'select_linked', 'select_linked_pick', 'select_loop', 'select_mode', 'select_more', 'select_overlap', 'select_pinned', 'select_similar', 'select_split', 'shortest_path_pick', 'shortest_path_select', 'smart_project', 'snap_cursor', 'snap_selected', 'sphere_project', 'stitch', 'unwrap', 'weld']
...
BLENDER_NODES = [
    ...
    blender_node.create_ops_class(
        blender_node.EditOps, 'ops.object.' + op, None, 'Object_') for op in object_vertex_group_api
] + [
