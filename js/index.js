  ...
  async setup() {
    ...
    api.addEventListener('executed', (evt) => {
      if (evt.detail?.output.gltfFilename) {
        const viewer = document.getElementById('avatech-viewer-iframe');
